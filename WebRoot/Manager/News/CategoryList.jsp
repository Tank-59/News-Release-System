...
<form id="form2" name="form2" method="post" action="">    
	...
	<tr>
	    ...
	    <td align="center"><a href="Manager/News/CategoryModify.jsp?id=${type.tid }">修改</a></td>
	    <td align="center"><a href="Back_Type_Delete?id=${type.tid }">删除</a></td>
	</tr>
	</c:forEach>
	...
	<a href="Manager/News/CategoryList.jsp?currentPage=1">首页</a> | 
	<a href="Manager/News/CategoryList.jsp?currentPage=${page.currentPage -1 }">上一页</a>
		</c:when>
		<c:otherwise>
			首页 | 上一页
		</c:otherwise>
	...
	<c:choose>
		<c:when test="${page.hasNextPage}">
			<a href="Manager/News/CategoryList.jsp?currentPage=${page.currentPage + 1 }">下一页</a> | 
	<a href="Manager/News/CategoryList.jsp?currentPage=${page.totalPage }">尾页</a>
		</c:when>
		<c:otherwise>
			下一页 | 尾页
		</c:otherwise>
